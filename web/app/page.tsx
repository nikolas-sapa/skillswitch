...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-2 mb-7">
      <span style={{ fontFamily: MONO }} className="text-[10px] text-[#5A5A6A] tracking-[0.12em] uppercase">
        {children}
      </span>
      ...
      <div className="max-w-[720px] mx-auto px-6">
        ...
        <section className="mb-[88px]">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <div className="flex items-center gap-2.5 bg-[#1A1A1E] border border-[#3A3A3F] rounded-[6px] px-4 py-2.5">
          ...
          <div className="flex flex-col">
            {STEPS.map(([num, cmd, desc]) => (
              <div key={num} className="flex gap-5 py-5 border-b border-[#2A2A2E] last:border-b-0">
                <span
                  style={{ fontFamily: MONO }}
                  className="text-[11px] text-[#5A5A6A] tracking-[0.06em] pt-0.5 shrink-0 w-7"
                >
                  {num}
                </span>
